...
def separt_positive(sequence, m, n):
    ...
    for i in range(len(sequence)):
        sequence[i] = sequence[i].translate(str.maketrans('', '', '#'))   ##so hard! just trans the '#' of each sequence to none,(para1 to para2,para3 to none)
...
def get_Matrix_Label (filename,site_type, m, n):
    ...
    ## np.copy:if change _2 or _3 ,input_sequence will not change
